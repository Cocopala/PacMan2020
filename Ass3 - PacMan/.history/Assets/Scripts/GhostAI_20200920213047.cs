...
public class GhostAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        CacluateDir(prev, next);
    }

    private void CacluateDir(Vector3 prev, Vector3 next)  // the ghost move direction
    {
        ...
        {
            animator.ChangeDir(yy > 0? SelfAnim.Anim_Dir.Right : SelfAnim.Anim_Dir.Left);
        }
    }
}
