...
public class SelfAnim : MonoBehaviour
{
    ...
    void Update()
    {
        if(Imput.GetKeyDown(KeyCode.RightArrow)) // right
        {
            ChangeDir(Anim_Dir.Right);
        }
        if(Imput.GetKeyDown(KeyCode.LeftArrow)) // left
        {
            ChangeDir(Anim_Dir.Left);
        }
        if(Imput.GetKeyDown(KeyCode.UpArrow)) // up
        {
            ChangeDir(Anim_Dir.Up);
        }
        if(Imput.GetKeyDown(KeyCode.DownArrow)) // down
        {
