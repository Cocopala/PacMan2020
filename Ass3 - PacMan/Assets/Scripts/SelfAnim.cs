...
public class SelfAnim : MonoBehaviour
{
    ...
    {
        None = -1, // because when the game start, if put right as default, the animation will freeze
        Right = 0,
        Left,
        Up,
        Down
    ...
    private Anim_Dir currDir = Anim_Dir.None; // when the user hold the direction key, the animation will paused.
